...
(function (window, undefined) {
    ...
    function _getMarkup(element, opts) {
        ...
        html.push('<script type="text/javascript">function printPage(){focus();$(document).ready(function(){print();});' + ((!$.support.opera && !opts["leaveOpen"] && opts["printMode"].toLowerCase() == 'popup') ? 'close();' : '') + '}</script>');        html.push('</body></html>');
